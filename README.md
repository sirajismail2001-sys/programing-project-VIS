...
## 📖 Project Overview
This repository contains a computational analysis of climate change impacts, specifically focusing on the synchronization of **heatwaves** and **droughts** (compound events). Using multi-model climate data, we quantify how the frequency and concurrence of these extreme events evolve under future emission scenarios (e.g., RCP 6.0) compared to a present baseline.
...
## 👥 Team Contributions
This analysis is a collaborative effort, with computational tasks divided among team members:
...
* **Development:** The interactive GUI was architected by **Siraj Ul Hasan Raja and Imdad Ullah**.
* **Implementation:** Code generation executed with the assistance of **AI (Gemini)**, under strict design parameters.
...
### 2. Environment Setup
To ensure compatibility and avoid version conflicts (especially with legacy Pickle files), please use the provided `environment.yml` file.
